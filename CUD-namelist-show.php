...
EOF;
				...
				while($row = pg_fetch_row($ret)){
					echo "<tr align=center><td>". $row[0] . "</td><td>".$row[1]."</td><td width = '300'>".$row[2]."</td><td><a href='update-namelist.php?id=$row[0]&name=$row[1]&remark=$row[2]'>編輯</a></td><td><a href='javascript:link2nthu($row[0])'>刪除</a></td></tr>";
					}
				pg_close($db);
