...
<div class="content-wrapper clearfix">
	...
	<table width="580" align="center" cellpadding="3" cellspacing="0" border="1">
		<tr align=center><td width="200">對象姓名</td><td width = "200">電話</td><td width="200">探訪者</td><td width = "200">日期</td><td width = "300">情&nbsp形</td><td width = "100">備&nbsp註</td><td width = "100">修改&刪除</td></tr>
		<?php
...
EOF;
				...
				while($row = pg_fetch_row($ret)){
					echo "<tr align=center><td valign=\"top\" align=\"left\">". $row[1] . "</td><td>".$row[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td><td>".$row[5]."</td><td>".$row[6]."</td><td><a href='U&D-recode.php?id=$row[0]&visitor=$row[3]&date=$row[4]&situation=$row[5]&remark=$row[6]'>編輯</a></td></tr>";
					}
				pg_close($db);
			}
