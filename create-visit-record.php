...
<div class="content-wrapper clearfix">
	...
	<form action="create-record.php" method="post">
			<h3 style="font-size:22px;">填表者姓名:<input type ="text" name="visitor" style="margin:0px 0px 0px 30px; height:30px; width:120px;"></h3>
...
EOF;
			...
			<textarea name="remark" style="height:80px; width:300px; margin:0px 0px 0px 30px;"></textarea></h3>
